...
export const achievements: Achievement[] = [
  ...
  { id: 'tw-ingestion', role: 'tastewise', tags: ['data', 'infra', 'backend'], strength: 5,
    text: 'Built the ingestion behind 1M+ indexed restaurants & venues, unifying 10 mismatched collectors into one schema and orchestrating the jobs on Airflow with KubernetesPodOperators (EKS).' },
  ...
  { id: 'tw-design-system', role: 'tastewise', tags: ['frontend', 'leadership'], strength: 3,
    text: 'Started Tastewise’s design system with the designers in 2023 and built its first Storybook — later the basis for the Storybook MCP that lets the internal app-builder’s agent build with the real components.' },
...
export const projects: Project[] = [
  ...
  { title: 'Ingestion at 1M+ restaurants & venues', years: '2024',
