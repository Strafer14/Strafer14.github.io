...
export const roles: Role[] = [
  ...
  },
  {
    ...
    stack: ['TypeScript', 'React', 'Node.js', 'AWS Lambda', 'SQS'],
  },
  {
    id: 'snipe',
    org: 'Snipe',
...
export const achievements: Achievement[] = [
  ...
  { id: 'zen-survey-platform', role: 'zencity', tags: ['backend', 'frontend', 'data', 'infra'], strength: 5,
    text: 'Cut survey-collection cost to near zero by replacing a third-party SaaS with an in-house platform — a React client plus an event-driven Lambda/SQS ingestion pipeline — running across ~100 cities at thousands of submissions a day.' },
...
export const skills: SkillGroup[] = [
  ...
  { title: 'Data Engineering', tags: ['data'], items: ['Databricks', 'Delta Lake', 'PySpark / Spark', 'Airflow (Astronomer)', 'Kinesis / Firehose', 'Pydantic', 'Elasticsearch', 'S3'] },
  { title: 'Cloud & Infra', tags: ['infra'], items: ['AWS', 'Kubernetes (EKS)', 'KubernetesPodOperators', 'Lambda', 'Datadog (APM/RUM)', 'Terraform'] },
  { title: 'Languages & Backend', tags: ['backend'], items: ['Python', 'TypeScript', 'Node.js', 'FastAPI', 'Flask', 'NestJS'] },
  { title: 'Frontend', tags: ['frontend'], items: ['React', 'React Native', 'Svelte', 'TypeScript', 'SCSS'] },
...
export const projects: Project[] = [
  ...
  { title: 'Observability overhaul', years: '2023',
    blurb: 'Moved the platform from Logz.io to Datadog and wrote a custom Node.js logger that every service uses.',
